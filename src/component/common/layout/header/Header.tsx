  ...
  return (
    <header className="flex items-center justify-center fixed top-0 right-0 bg-black/60 z-50 w-full h-14 px-5">
      <div className="flex items-center justify-between w-full max-w-6xl mx-auto">
        <h1 className="hidden lg:block text-[#fbefd8] font-bold">LOGO</h1>
        ...
        <button onClick={() => setSidebarOpen(true)} className="md:hidden bg-[#fbefd8] rounded-lg p-0.5 hover:bg-[#fbefd8b0] transition-all">
          <GiHamburgerMenu className="text-[#120b04] text-2xl" />
        </button>
