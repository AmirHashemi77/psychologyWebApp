  ...
  return (
    <div className="w-full h-screen relative overflow-hidden">
      <div className="flex flex-col-reverse xl:flex-row items-center justify-between w-full h-full">
        <div className="flex items-center justify-start xl:justify-center gap-5 flex-col w-full xl:w-1/2 h-full bg-hero px-5 py-24 xl:py-0">
          <h1 className="text-[#fbefd8] text-center font-bold tex-center text-3xl xl:text-5xl py-5 font-vazir">مرکز روانشناسی دکتر خمسه</h1>
