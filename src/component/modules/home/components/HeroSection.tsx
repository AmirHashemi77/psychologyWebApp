    ...
    <div className="w-full h-screen relative overflow-hidden">
      <div className="flex flex-col-reverse xl:flex-row items-center justify-between w-full h-full">
        <div className="flex items-center justify-start xl:justify-center gap-5 flex-col w-full xl:w-1/2 h-full bg-hero px-5 py-24 xl:py-0 rounded-2xl relative">
          <Image width={200} height={400} src="/images/logo.svg" className="my-5" alt="vector" />
          ...
          <Image width={200} height={400} src="/images/vector1.svg" className=" hidden md:block absolute z-0 rotate-45  bottom-1 -right-3 img-flip" alt="vector" />
          <Image width={200} height={400} src="/images/vector1.svg" className="hidden md:block absolute z-0 -rotate-45  bottom-1 -left-3 " alt="vector" />
        </div>
