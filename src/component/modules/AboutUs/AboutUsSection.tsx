        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-xl p-6 shadow-sm">
            ...
            <p className="text-foreground/80 font-vazir leading-relaxed text-justify">
              دکتر مرضیه خمسه یک روان‌درمانگر و روان‌شناس ایرانی و عضو انجمن روانشناسی امریکا (APA) است. ایشان با بیش از ۱۷ سال تجربه در مشاوره و جلسات روان‌تحلیلی، خدمات تخصصی خود را به صورت حضوری و
              غیرحضوری (آنلاین) به ایرانیان داخل و خارج از کشور ارائه می‌نماید.
            </p>
          </div>
